...
int main(){
    ...
    cin>>d;
    Number input1(a,b),input2(c,d);
    Number sum=input1+input2;
    Number difference=input1-input2;
    Number Multiplication=input1*input2; 
    Number Division=input1/input2;
    int op;
    do
    {
